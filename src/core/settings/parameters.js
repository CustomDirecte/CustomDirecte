...
new Switch(notesTable, "customNotesEnabled", "file-bookmark", "Activer les notes custom", "Active ou désactive les notes et matières personnalisées dans le tableau et leurs calculs", true, false);
new Switch(notesTable, "bacCalculator", "calculator", "Afficher le calculateur du bac", "Affiche sous le tableau des notes un bouton pour ouvrir le calculateur du bac", true, false);
...
new RowSelector(
  ...
  "Sélectionnez l’apparence du popup. Le changement est appliqué immédiatement.",
  "classic",
  [
    { id: "classic", name: "Moderne" },
    { id: "legacy", name: "Classique" },
  ],
  false
);
