defaultOptions = {
  groups: [
    ...
    },
    {
      ...
      Subtitle: "Activer ou désactiver les fonctionnalités personnalisées de notes",
    },
    {
      ID: "sidebar",
  ...
  options: [
    ...
    },
    {
      ...
      Value: null,
      Default: true,
      option: "customNotesFeature",
      Title: "Notes custom",
      Subtitle: "Ajouter des notes prédictives et gérer l'ensemble du système autour",
      reloadingRequired: true,
      lock: "noteTableAnalysis",
    },
    {
      ...
      Value: null,
      Default: true,
      option: "customSubjectsFeature",
      Title: "Matières custom",
      Subtitle: "Ajouter une matière et gérer l'ensemble du système autour",
      reloadingRequired: true,
      lock: "noteTableAnalysis",
      requires: "customNotesFeature",
    },
    {
      Group: "features",
      Type: "Switch",
      Value: null,
      Default: true,
      option: "editNotesFeature",
      Title: "Modifier une note",
      Subtitle: "Modifier une note déjà présente sur EcoleDirecte",
      reloadingRequired: true,
      lock: "noteTableAnalysis",
    },
    {
