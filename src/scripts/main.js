...
var initialize = {
  ...
  defaultCSS() {
    try {
      ...
      console.error("Erreur lors de l'ajout du CSS par défaut :", error);
    }
  },
  ...
  menuButton() {
    try {
      ...
      console.error("Erreur lors de la création du bouton de menu :", error);
    }
  },
  ...
  popupFrame() {
    try {
      ...
      console.error("Erreur lors de la création du popup des options :", error);
    }
  },
  ...
  all() {
    ...
    if (!settingsButton || !settingsPopup || !settingsPopupBlur) {
      console.error("Erreur lors de l'initialisation de l'interface : un élément n'a pas pu être créé.");
      return;
    }
...
//       menuAddNewOptions("Options", "fa-cog", "Personnalisation", () => document.querySelector("html").classList.add("settings-popup-active"));
...
//   settingsButtonDiv = document.createElement("div");
//   settingsButtonDiv.classList.add("settingsButton");
//   settingsButtonIcon = document.createElement("i");
//   settingsButtonIcon.classList.add("fa", "fa-pencil");
//   settingsButtonSpan = document.createElement("span");
//   settingsButtonSpan.innerText = "Personnaliser EcoleDirecte";
//   document.body.prepend(settingsButtonDiv);
//   settingsButtonDiv.appendChild(settingsButtonIcon);
//   settingsButtonDiv.appendChild(settingsButtonSpan);
//   settingsButtonDiv.onclick = () => {
//     if (document.querySelector("html").classList.contains("settings-popup-active")) document.querySelector("html").classList.remove("settings-popup-active");
//     else document.querySelector("html").classList.add("settings-popup-active");
//   };

//   settingsPopupBlur = document.createElement("div");
//   settingsPopupBlur.classList.add("settingsPopupBlur");
//   document.body.prepend(settingsPopupBlur);

//   settingsPopup = document.createElement("iframe");
//   settingsPopup.classList.add("settingsPopup");
//   document.body.prepend(settingsPopup);
//   settingsPopup.src = browser.runtime.getURL("/pages/popup/interface.html");

//   function closesettingsPopup() {
//     settingsPopup.contentWindow.postMessage("close", "*");
//   }
...
//   settingsPopupBlur.onclick = async () => {
//     closesettingsPopup();
//   };
...
//   window.addEventListener("message", (e) => {
//     if (e.data == "closesettingsPopup") {
//       document.querySelector("html").classList.remove("settings-popup-active");
//     }
//     if (e.data == "reloadsettingsPopup") {
//       location.reload();
//     }
//   });
// }
