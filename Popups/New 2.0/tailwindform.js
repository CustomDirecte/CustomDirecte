...
const svgToDataUri = svgToDataURL;
  ...
  return function ({ addBase, addComponents, theme }) {
    ...
    const rules = [
      ...
      },
      {
        ...
        class: [".form-select"],
        styles: {
          "background-image": `url("${svgToDataUri(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20"><path stroke="${resolveChevronColor("colors.gray.500", colors.gray[500])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 8l4 4 4-4"/></svg>`)}")`,
      ...
      {
        base: [`:root[class~='dark'] [type='radio']:checked`],
        class: [".form-radio:checked"],
        styles: {
          "background-image": `url("${svgToDataUri(`<svg viewBox="0 0 16 16" fill="#26282c" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="3"/></svg>`)}")`,
