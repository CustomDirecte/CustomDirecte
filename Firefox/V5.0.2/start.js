...
browser.storage.local.get("newEcoleDirecteInterface", function (data) {
...
function averageCalculator() {
  ...
  function averageLoad() {
    ...
    document.querySelector("tabset > ul").onclick = function () {
      averageLoad();
    };
    ...
    if (document.querySelector("table")) {
      ...
      tableConfiguration = { coef: false, relevemoyenne: false, notes: false };
      for (
        var i = 0;
      ...
      if (tableConfiguration["notes"]) {
        ...
        console.error("Notes Introuvables");
        alert("Vos notes sont introuvable !");
      }
    }
  }
}
